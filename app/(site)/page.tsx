...
export default function Home() {
	return (
		<main className={styles.main}>
			...
			<div className={styles.centerContent}>
				<div className={styles.homeGetInvolved}>
					...
					<div className={styles.getInvolvedSection}>
						...
						<p>
							Presentations immediately proceeding the SLC meetup, as well as monthly study groups. Schedule on
							Meetup.com.
						</p>
					</div>
					<div className={styles.getInvolvedSection}>
			...
			<p>
				UtahJS is a 501(c)(3) organization and contributions are tax deductible. We are run by a passionate group of
				volunteers. To help out or make a donation or sponsor this site or an event please contact Ken Snyder at
				ken@utahjs.com.
			</p>
		</main>
	);
